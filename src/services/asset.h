...
#ifndef PAYDAYCOIN_SERVICES_ASSET_H
#define PAYDAYCOIN_SERVICES_ASSET_H
...
const int PAYDAYCOIN_TX_VERSION_MINT = 0x7400;
const int PAYDAYCOIN_TX_VERSION_BURN = 0x7401;
const int PAYDAYCOIN_TX_VERSION_ASSET_ACTIVATE = 0x7402;
const int PAYDAYCOIN_TX_VERSION_ASSET_UPDATE = 0x7403;
const int PAYDAYCOIN_TX_VERSION_ASSET_TRANSFER = 0x7404;
const int PAYDAYCOIN_TX_VERSION_ASSET_SEND = 0x7405;
const int PAYDAYCOIN_TX_VERSION_ASSET_ALLOCATION_MINT = 0x7406;
const int PAYDAYCOIN_TX_VERSION_ASSET_ALLOCATION_BURN = 0x7407;
const int PAYDAYCOIN_TX_VERSION_ASSET_ALLOCATION_SEND = 0x7408;
const int PAYDAYCOIN_TX_VERSION_ASSET_ALLOCATION_LOCK = 0x7409;
...
bool GetPaydayCoinData(const CTransaction &tx, std::vector<unsigned char> &vchData, int& nOut);
bool GetPaydayCoinData(const CScript &scriptPubKey, std::vector<unsigned char> &vchData);
...
public:
    ...
    CMintPaydayCoin(const CTransaction &tx) {
        SetNull();
        UnserializeFromTx(tx);
    }
    ADD_SERIALIZE_METHODS;
...
#endif // PAYDAYCOIN_SERVICES_ASSET_H
