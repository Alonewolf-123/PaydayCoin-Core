...
#ifndef PAYDAYCOIN_KEYSTORE_H
#define PAYDAYCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/paydaycoin/bips/blob/master/bip-0013.mediawiki
