...
// PAYDAYCOIN
bool CZMQPublishRawPaydayCoinNotifier::NotifyPaydayCoinUpdate(const char * value, const char * topic)
{
    LogPrint(BCLog::ZMQ, "zmq: Publish raw paydaycoin payload for topic %s: %s\n", topic, value);
