...
#ifndef PAYDAYCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define PAYDAYCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
public:
    ...
    // PAYDAYCOIN
    virtual bool NotifyPaydayCoinUpdate(const char *, const char *);
...
#endif // PAYDAYCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
