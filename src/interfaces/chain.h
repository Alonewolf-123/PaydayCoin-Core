...
#ifndef PAYDAYCOIN_INTERFACES_CHAIN_H
#define PAYDAYCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the paydaycoin node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/paydaycoin/paydaycoin/pull/10973#issuecomment-380101269).
//!
//! * The relayTransactions() and submitToMemoryPool() methods could be replaced
//!   with a higher-level broadcastTransaction method
//!   (https://github.com/paydaycoin/paydaycoin/pull/14978#issuecomment-459373984).
//!
//! * The initMessages() and loadWallet() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/paydaycoin/paydaycoin/pull/15288#discussion_r253321096).
//!
...
#endif // PAYDAYCOIN_INTERFACES_CHAIN_H
