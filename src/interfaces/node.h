...
#ifndef PAYDAYCOIN_INTERFACES_NODE_H
#define PAYDAYCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a paydaycoin node (paydaycoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // PAYDAYCOIN_INTERFACES_NODE_H
