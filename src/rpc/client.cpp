...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "voteraw", 1, "tx_index" },
    { "voteraw", 5, "time" },
    { "paydaycoinmint", 1, "amount" },
    { "paydaycoinmint", 2, "blocknumber" },
    { "paydaycoinburn", 1, "amount" },
    { "sendfrom", 2, "amount" },
    { "paydaycointxfund", 2, "output_index" },
    ...
    { "paydaycoinsetethstatus", 1, "highestBlock" },
    { "paydaycoinsetethheaders", 0, "headers" },
