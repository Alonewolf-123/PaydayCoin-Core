...
#ifndef PAYDAYCOIN_WALLET_WALLET_H
#define PAYDAYCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! paydaycoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this paydaycoin node, and set to 0 for transactions that were created
...
#endif // PAYDAYCOIN_WALLET_WALLET_H
