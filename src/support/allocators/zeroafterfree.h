...
#ifndef PAYDAYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define PAYDAYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // PAYDAYCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
