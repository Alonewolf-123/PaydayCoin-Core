...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", PaydayCoinUnits::PDAY);
    ...
    // PAYDAYCOIN
    if (!settings.contains("strDataDirPaydayCoin"))
        settings.setValue("strDataDirPaydayCoin", GUIUtil::getDefaultDataDirectory());
...
void OptionsModel::Reset()
{
    ...
    // PAYDAYCOIN Save the strDataDirPaydayCoin setting
    QString dataDir = GUIUtil::getDefaultDataDirectory();
    dataDir = settings.value("strDataDirPaydayCoin", dataDir).toString();

    // Remove all entries from our QSettings object
    settings.clear();

    // PAYDAYCOIN Set strDataDirPaydayCoin
    settings.setValue("strDataDirPaydayCoin", dataDir);
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/paydaycoin/paydaycoin/pull/8273
