...
#ifndef PAYDAYCOIN_QT_SPLASHSCREEN_H
#define PAYDAYCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. PaydayCoin Core initialization
...
#endif // PAYDAYCOIN_QT_SPLASHSCREEN_H
