...
#ifndef PAYDAYCOIN_QT_RPCCONSOLE_H
#define PAYDAYCOIN_QT_RPCCONSOLE_H
...
public Q_SLOTS:
    ...
    /** PAYDAYCOIN Set number of masternodes shown in the UI */
...
#endif // PAYDAYCOIN_QT_RPCCONSOLE_H
