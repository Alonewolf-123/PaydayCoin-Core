...
//! Entry point for PaydayCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PaydayCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PaydayCoinGUI tests.
void AppTests::guiTests(PaydayCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PaydayCoinGUI::consoleShown, this, &AppTests::consoleTests);
