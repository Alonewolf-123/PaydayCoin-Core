...
#ifndef PAYDAYCOIN_QT_TEST_PAYMENTREQUESTDATA_H
#define PAYDAYCOIN_QT_TEST_PAYMENTREQUESTDATA_H
...
//
// Payment request with amount overflow (amount is set to 21000001 PDAY)
//
...
#endif // PAYDAYCOIN_QT_TEST_PAYMENTREQUESTDATA_H
