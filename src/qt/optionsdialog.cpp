    ...
    mapper(nullptr)
{
    ...
    ui->paydaycoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->paydaycoinAtStartup);
    ...
    ui->paydaycoinAtStartup->setToolTip(ui->paydaycoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->paydaycoinAtStartup->setText(ui->paydaycoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openPaydayCoinConfButton->setToolTip(ui->openPaydayCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PaydayCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->paydaycoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPaydayCoinConfButton_clicked()
{
