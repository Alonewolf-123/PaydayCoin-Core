    ...
    platformStyle(_platformStyle)
{
    ...
    // normal paydaycoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying paydaycoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PaydayCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
