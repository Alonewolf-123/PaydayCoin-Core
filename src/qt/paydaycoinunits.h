...
#ifndef PAYDAYCOIN_QT_PAYDAYCOINUNITS_H
#define PAYDAYCOIN_QT_PAYDAYCOINUNITS_H
...
/** PaydayCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PaydayCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PaydayCoinUnits(QObject *parent);

    /** PaydayCoin units.
      @note Source: https://en.paydaycoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PDAY,
...
typedef PaydayCoinUnits::Unit PaydayCoinUnit;

#endif // PAYDAYCOIN_QT_PAYDAYCOINUNITS_H
