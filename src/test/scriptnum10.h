...
#ifndef PAYDAYCOIN_TEST_SCRIPTNUM10_H
#define PAYDAYCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from PaydayCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PAYDAYCOIN_TEST_BIGNUM_H
