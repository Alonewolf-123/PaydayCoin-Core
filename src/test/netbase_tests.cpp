...
{
    BOOST_CHECK(TestSplitHost("www.paydaycoin.org", "www.paydaycoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.paydaycoin.org]", "www.paydaycoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.paydaycoin.org:80", "www.paydaycoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.paydaycoin.org]:80", "www.paydaycoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8123", "127.0.0.1", 8123));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8123", "127.0.0.1", 8123));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8123", "::ffff:127.0.0.1", 8123));
    BOOST_CHECK(TestSplitHost("[::]:8123", "::", 8123));
    BOOST_CHECK(TestSplitHost("::8123", "::8123", -1));
    BOOST_CHECK(TestSplitHost(":8123", "", 8123));
    BOOST_CHECK(TestSplitHost("[]:8123", "", 8123));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8123", "127.0.0.1:8123"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8123", "[::]:8123"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
