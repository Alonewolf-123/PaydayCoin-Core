...
static void SetupPaydayCoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " paydaycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  paydaycoin-tx [options] <hex-tx> [commands]  Update hex-encoded paydaycoin transaction\n" +
            "or:     paydaycoin-tx [options] -create [commands]   Create hex-encoded paydaycoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paydaycoin transaction
