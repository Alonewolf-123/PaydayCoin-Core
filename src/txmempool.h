...
#ifndef PAYDAYCOIN_TXMEMPOOL_H
#define PAYDAYCOIN_TXMEMPOOL_H
...
enum class MemPoolRemovalReason {
    ...
    // PAYDAYCOIN
    PAYDAYCOIN,     //!< Removed for failure of asset consensus
};
...
public:
     ...
     * https://github.com/paydaycoin/paydaycoin/pull/14193 will fix it. No known code
     * in paydaycoin currently depends on second guarantee, but it is important to
