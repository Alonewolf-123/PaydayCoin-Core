...
#ifndef PAYDAYCOIN_NET_H
#define PAYDAYCOIN_NET_H
 ...
 * currently acceptable).  PaydayCoin has 4 MiB here, but we need more space
...
public:
    ...
    // PAYDAYCOIN If 'true' this node will be disconnected on CMasternodeMan::ProcessMasternodeConnections()
    bool fMasternode;
...
public:
    ...
    std::set<uint256> setInventoryTxToSend GUARDED_BY(cs_inventory);
    // List of block ids we still have announce.
    // There is no final sorting before sending, as they are always sent immediately
    // and in the order requested.
       // PAYDAYCOIN List of non-tx/non-block inventory items
