// Copyright (c) 2010-2018 The PaydayCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PAYDAYCOIN_UTIL_ERROR_H
#define PAYDAYCOIN_UTIL_ERROR_H
 ...
 *
 * Error types defined here can be used in different parts of the paydaycoin
