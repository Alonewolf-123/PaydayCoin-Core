 ...
 */
#ifndef PAYDAYCOIN_UTIL_PDAYTEM_H
#define PAYDAYCOIN_UTIL_PDAYTEM_H
...
extern const char * const PAYDAYCOIN_CONF_FILENAME;
...
bool StartGethNode(const std::string &exePath, pid_t &pid, bool bGethTestnet = false, int websocketport=8717);
bool StopGethNode(pid_t &pid);
fs::path GetRelayerPidFile();
std::string GeteRelayerFilename();
bool StartRelayerNode(const std::string &exePath, pid_t &pid, int rpcport, bool bGethTestnet, int websocketport=8717);
...
#endif // PAYDAYCOIN_UTIL_PDAYTEM_H
