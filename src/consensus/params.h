...
#ifndef PAYDAYCOIN_CONSENSUS_PARAMS_H
#define PAYDAYCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    // PAYDAYCOIN
    std::vector<unsigned char> vchPDAYXContract;
    std::vector<unsigned char> vchPDAYXBurnMethodSignature;
...
#endif // PAYDAYCOIN_CONSENSUS_PARAMS_H
