...
// Copyright (c) 2009-2013 The PaydayCoin developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PAYDAYCOIN_PRIMITIVES_PUREHEADER_H
#define PAYDAYCOIN_PRIMITIVES_PUREHEADER_H
...
#endif // PAYDAYCOIN_PRIMITIVES_PUREHEADER_H
