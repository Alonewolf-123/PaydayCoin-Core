...
#ifndef PAYDAYCOIN_SCRIPT_STANDARD_H
#define PAYDAYCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a paydaycoin address
 */
...
/**
 * Generate a PaydayCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PAYDAYCOIN_SCRIPT_STANDARD_H
