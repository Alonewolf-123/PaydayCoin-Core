#!/usr/bin/env python3
# Copyright (c) 2016-2019 The PaydayCoin Core developers
...
# TestP2PConn: A peer we use to send messages to paydaycoind, and store responses.
...
class CompactBlocksTest(PaydayCoinTestFramework):
    ...
    # This test actually causes paydaycoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that paydaycoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for paydaycoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # paydaycoind will not send blocktxn responses for blocks whose height is
