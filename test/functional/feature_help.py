...
"""Verify that starting paydaycoin with -h works as expected."""

from test_framework.test_framework import PaydayCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PaydayCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start paydaycoin with -h for help text")
        ...
        self.log.info("Start paydaycoin with -version for version information")
        ...
        self.log.info("Start paydaycoind with -fakearg to make sure it does not start")
