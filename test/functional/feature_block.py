...
class FullBlockTest(PaydayCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure paydaycoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure paydaycoind isn't accepting b28
        ...
        # Upstream PaydayCoin tests BIP30 here.  We cannot do that, as BIP34 is
        ...
        # paydaycoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the paydaycoin code has custom code which does so);
