#!/usr/bin/env python3
# Copyright (c) 2018-2019 The PaydayCoin Core developers
...
class PSBTTest(PaydayCoinTestFramework):

    def set_test_params(self):
        self.setup_clean_chain = False
        self.num_nodes = 3
        # Upstream PaydayCoin has p2sh-segwit as default address type and this
        # test depends on that.  Since we changed it (for now, pending
        # segwit activation in PaydayCoin), explicitly specify the address
        # type for this test.
    ...
    def run_test(self):
        ...
        self.sync_all()
        # Create and fund a raw tx for sending 10 PDAY
