...
By default, paydaycoind will dump mempool on shutdown and
...
class MempoolPersistTest(PaydayCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent paydaycoind from writing mempool.dat to disk. Verify that `savemempool` fails")
