...
class RawTransactionsTest(PaydayCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid PaydayCoin address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        # 1000 sat fee, ~100 b transaction, fee rate should land around 10 sat/b = 0.00010000 PDAY/kB
