...
"""
    ...
    PaydayCoin should be started with the command line arguments:
        paydaycoind -testnet -daemon \
    ...
    https://github.com/paydaycoin/paydaycoin/blob/37a7fe9e440b83e2364d5498931253937abe9294/contrib/zmq/zmq_sub.py
"""
