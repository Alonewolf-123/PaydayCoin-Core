PaydayCoin Core version 0.9.4 is now available from:

  https://paydaycoin.org/bin/0.9.4/
...
this update is incompatible with the PaydayCoin system and could lead to consensus
forks.

PaydayCoin Core released binaries from https://paydaycoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~paydaycoin/+archive/ubuntu/paydaycoin
- A third-party or self-compiled PaydayCoin Core

upgrade to PaydayCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
