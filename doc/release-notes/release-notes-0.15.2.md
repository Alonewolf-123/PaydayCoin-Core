PaydayCoin Core version *0.15.2* is now available from:

  <https://paydaycoincore.org/bin/paydaycoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in paydaycoin-tx (TheBlueMatt)
