PaydayCoin Core version 0.16.1 is now available from:

  <https://paydaycoincore.org/bin/paydaycoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting paydaycoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure paydaycoind processes are cleaned up when tests end (sdaftuar)
