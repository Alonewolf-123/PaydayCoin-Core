PaydayCoin Core version 0.14.2 is now available from:

  <https://paydaycoin.org/bin/paydaycoin-core-0.14.2/>
...
(in PaydayCoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate paydaycoin-config.h as necessary (theuni)
