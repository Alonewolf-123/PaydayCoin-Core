PaydayCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/paydaycoin/files/PaydayCoin/paydaycoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the PaydayCoin
...
New/changed settings (command-line or paydaycoin.conf file)
--------------------------------------------------------
