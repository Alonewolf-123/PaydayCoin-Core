PaydayCoin Core version *0.15.0.1* is now available from:

  <https://paydaycoin.org/bin/paydaycoin-core-0.15.0.1/>

and

  <https://paydaycoincore.org/bin/paydaycoin-core-0.15.0.1/>
