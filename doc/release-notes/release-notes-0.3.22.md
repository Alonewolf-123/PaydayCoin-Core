Download URL: https://sourceforge.net/projects/paydaycoin/files/PaydayCoin/paydaycoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PDAY fee schedule (users still pay 0.01 PDAY per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #paydaycoin00 - #paydaycoin99
