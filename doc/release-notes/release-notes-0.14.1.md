PaydayCoin Core version 0.14.1 is now available from:

  <https://paydaycoin.org/bin/paydaycoin-core-0.14.1/>
...
here:
[reducing-paydaycoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` paydaycoin-tx input verification (awemany, jnewbery)
