PaydayCoin Core version 0.13.2 is now available from:

  <https://paydaycoin.org/bin/paydaycoin-core-0.13.2/>
...
- #8908 `4a974b2` Update paydaycoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow paydaycoin-tx to create v2 transactions (sysdrak)
