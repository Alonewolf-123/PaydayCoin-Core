PaydayCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/paydaycoin/files/PaydayCoin/paydaycoin-0.5.4/
...
http://gitorious.org/paydaycoin/paydaycoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix PaydayCoin-Qt notifications under Growl 1.3.
Increase required age of PaydayCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPaydayCoin properly when installing PaydayCoin-Qt over it. (Windows)
