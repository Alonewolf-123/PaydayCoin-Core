PaydayCoin Core version 0.9.2.1 is now available from:

  https://paydaycoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PDAY to 0.01 PDAY
...
- Fix "Start paydaycoin on system login"
