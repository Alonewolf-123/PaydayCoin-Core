PaydayCoin Core version 0.10.4 is now available from:

  <https://paydaycoin.org/bin/paydaycoin-core-0.10.4/>
...
- #6953 `43c2789` Split paydaycoin-tx into its own package
- #6953 `dfe0d4d` Include paydaycoin-tx binary on Debian/Ubuntu
