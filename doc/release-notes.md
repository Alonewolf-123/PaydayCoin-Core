...
PaydayCoin Core version *version* is now available from:

  <https://paydaycoincore.org/bin/paydaycoin-core-*version*/>
...
Upgrading directly from a version of PaydayCoin Core that has reached its EOL is
possible, but might take some time if the datadir needs to be migrated.  Old
wallet versions of PaydayCoin Core are generally supported.
...
PaydayCoin Core is supported and extensively tested on operating systems using
the Linux kernel, macOS 10.10+, and Windows 7 and newer.  It is not recommended
to use PaydayCoin Core on unsupported systems.
...
10.10.  Additionally, PaydayCoin Core does not yet change appearance when
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/paydaycoin/paydaycoin/).
