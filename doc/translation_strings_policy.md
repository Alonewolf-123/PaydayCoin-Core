...
This document provides guidelines for internationalization of the PaydayCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `paydaycoin_en.ts` remains unchanged.
