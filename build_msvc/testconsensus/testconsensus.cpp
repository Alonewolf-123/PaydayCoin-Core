...
// paydaycoin includes.
#include <..\src\script\paydaycoinconsensus.h>
...
int main()
{
    std::cout << "paydaycoinconsensus version: " << paydaycoinconsensus_version() << std::endl;
    ...
    auto op0Result = paydaycoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, paydaycoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
